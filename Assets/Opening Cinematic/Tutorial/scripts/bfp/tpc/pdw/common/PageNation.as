package bfp.tpc.pdw.common
{
   ...
   public class PageNation extends Sprite
   {
      ...
      public function PageNation(param1:uint = 1, param2:uint = 6, param3:Rectangle = null, param4:uint = 1, param5:Boolean = false)
      {
         super();
