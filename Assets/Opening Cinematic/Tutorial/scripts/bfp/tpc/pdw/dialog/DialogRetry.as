package bfp.tpc.pdw.dialog
{
   ...
   public class DialogRetry extends Alert implements IDialog
   {
      ...
      override public function init() : void
      {
         ...
         this.title_tf.y = 33;
         FontManager.setTextID(this.title_tf,"dialog_30");
         ...
         this.closemc.tf.y = 5;
         FontManager.setTextID(this.closemc.tf,"dialog_31");
         super.init();
      }
      ...
      private function clickHandler(param1:MouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            case "closemc":
               ColorUtilities.reset(_loc2_.bgmc);
               this.away();
               PDWBridge.dispatchEvent(new PDWBridgeEvent(PDWBridgeEvent.DIALOG_CLOSE,{"dialog":PDWBridge.DIALOG_TYPE_RETRY}));
         }
      }
   }
}
