package bfp.common
{
   ...
   public class FontManager
   {
      ...
      public static function markupMultilingualText(param1:String, param2:Boolean = false) : String
      {
      ...
      public static function setTextID(param1:TextField, param2:String, param3:Boolean = false) : void
      {
         ...
         {
            _loc4_ = textFieldManager.createTextFormat(param1,param2);
            param1.text = textFieldManager.getIdText(param2);
            setBaseline(param1,_loc4_);
            setSelectedFont(param1,_loc4_.boldFlag);
         }
      }
      ...
      public static function setAutoFontText(param1:TextField, param2:String, param3:Boolean = false) : void
      {
         var _loc4_:String = "";
         var _loc5_:String = "";
         switch(lang_code)
         ...
         var _loc6_:String = markupMultilingualText(param2,param3);
         _loc4_ = "<FONT FACE=\"" + _loc5_ + "\">" + _loc6_ + "</FONT>";
         param1.embedFonts = true;
         param1.htmlText = _loc4_;
      }
