package bfp.common
{
   ...
   public class PokemonBridge
   {
      ...
      public static function setAPI(param1:String) : void
      {
         ...
         {
            if(PokemonBridge.PATH.indexOf("swan") != -1)
            {
               PDW_API = "http://pokemon-swan-pdw" + world_id + ".basementfactorysystems.com/api/";
               PDW_API_SSL = "https://pokemon-swan-pdw" + world_id + ".basementfactorysystems.com/api/";
            }
            else
            {
         ...
         else if(PokemonBridge.PATH.indexOf("http://test") != -1)
         {
            PDW_API = "http://test-pdw" + world_id + ".pokemon-gl.com/api/";
            PDW_API_SSL = "https://test-pdw" + world_id + ".pokemon-gl.com/api/";
         }
         else if(PokemonBridge.PATH.indexOf("http://stg") != -1)
         {
            PDW_API = "http://stg-pdw" + world_id + ".pokemon-gl.com/api/";
            PDW_API_SSL = "https://stg-pdw" + world_id + ".pokemon-gl.com/api/";
         }
         else if(PokemonBridge.PATH.indexOf("http://dev-") != -1)
         {
            PDW_API = "http://dev-pdw" + world_id + ".pokemon-gl.com/api/";
            PDW_API_SSL = "https://dev-pdw" + world_id + ".pokemon-gl.com/api/";
         }
         else
         {
