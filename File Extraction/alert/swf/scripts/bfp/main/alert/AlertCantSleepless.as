package bfp.main.alert
{
   ...
   public class AlertCantSleepless extends EventDispatcher
   {
      ...
      public function AlertCantSleepless(container:MovieClip)
      {
         super();
         this._container = container;
         this._container.visible = false;
         this._bt = this._container.bt;
         this._messageTf = this._container.message;
      ...
      private function init() : void
      {
         ...
         FontManager.setAutoFontTextID(this._buttonTf,"pg_ale_2");
         this._messageTf.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._messageTf,"pg_ale_1");
         this._messageTf.autoSize = TextFieldAutoSize.LEFT;
         this._messageTf.y = 200 - Math.floor(this._messageTf.height / 2);
      }
