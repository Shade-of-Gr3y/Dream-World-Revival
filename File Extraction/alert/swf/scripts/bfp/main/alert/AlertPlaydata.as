package bfp.main.alert
{
   ...
   public class AlertPlaydata extends EventDispatcher
   {
      ...
      public function AlertPlaydata(container:MovieClip)
      {
         super();
      ...
      private function init() : void
      {
         ...
         FontManager.setAutoFontTextID(this._buttonTf,"pg_ald_2");
         this._messageTf.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._messageTf,"pg_ald_1");
