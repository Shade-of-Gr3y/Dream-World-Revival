package bfp.main.alert
{
   ...
   public class AlertWakeup extends EventDispatcher
   {
      ...
      public function AlertWakeup(container:MovieClip)
      {
         super();
      ...
      private function init() : void
      {
         ...
         FontManager.setAutoFontTextID(this._buttonTf,"pg_alf_3");
         this._messageTf.y = 0;
         this._messageTf.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._messageTf,"pg_alf_1");
         this._infoTf.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._infoTf,"pg_alf_2");
