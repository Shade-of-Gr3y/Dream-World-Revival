package bfp.main.alert
{
   ...
   public class AlertBusy extends EventDispatcher
   {
      ...
      public function AlertBusy(container:MovieClip)
      {
         super();
      ...
      private function init() : void
      {
         ...
         this._title.y = 0;
         FontManager.setAutoFontTextID(this._title,"pg_ade_1");
         this._title.autoSize = TextFieldAutoSize.LEFT;
         this._title.autoSize = TextFieldAutoSize.CENTER;
         this._btf1.y = 8;
         this._btf1.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._btf1,"pg_ade_4");
         this._btf2.y = 8;
         this._btf2.mouseEnabled = false;
         FontManager.setAutoFontTextID(this._btf2,"pg_ade_5");
         var _mes:String = "";
         if(PokemonBridge.sleeping_flag)
         {
            _mes = FontManager.getIdText("pg_ade_3");
         }
         else
         {
            _mes = FontManager.getIdText("pg_ade_2");
         }
         FontManager.setTextAndFormatTag(this._message,FontManager.markupMultilingualText(_mes),"pg_ade_2");
