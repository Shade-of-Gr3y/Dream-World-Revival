package bfp.common
{
   ...
   public class textFieldManager
   {
      ...
      public static function setAntiAlias(param1:*, param2:*, param3:*) : void
      {
         ...
         if((Boolean(_loc4_)) && _loc4_.@font.toString() != "")
         {
            _loc5_ = _fonts[_loc4_.@font.toString()];
            param3.font = _loc5_.@name.toString();
            if(_loc5_.@font === "normal")
            {
               _loc6_ = AntiAliasType.NORMAL;
            }
            else if(_loc5_.@font === "advanced")
            {
               _loc6_ = AntiAliasType.ADVANCED;
            }
            if(_loc5_.@gridFitType.toString() != "")
            {
               _loc6_ = AntiAliasType.ADVANCED;
            }
            if(_loc6_)
            {
               param1.antiAliasType = _loc6_;
            }
            if(_loc5_.@gridFitType === "none")
            {
               _loc7_ = GridFitType.NONE;
            }
            else if(_loc5_.@gridFitType === "pixel")
            {
               _loc7_ = GridFitType.PIXEL;
            }
            else if(_loc5_.@gridFitType === "subpixel")
            {
            ...
            if(_loc5_.@sharpness.toString() != "")
            {
               param1.sharpness = _loc5_.@sharpness;
            }
            if(_loc5_.@thickness.toString() != "")
            {
               param1.thickness = _loc5_.@thickness;
            }
         }
      }
      ...
      public static function createTextFormatTag(param1:String) : Object
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc7_ = _fonts[_loc3_.@font.toString()];
               if(_loc7_.@name)
               {
                  _loc4_ += " face=\'" + _loc7_.@name.toString() + "\'";
               }
            }
            ...
            {
               _loc8_ = _loc3_.@color;
               if(_loc8_.substr(0,2) == "0x" || _loc8_.substr(0,2) == "0X")
               {
