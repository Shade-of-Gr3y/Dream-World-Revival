package bfp.pdw.farm.field
{
   ...
   public class NutsInfomationFukidashi extends MovieClip
   {
      ...
      private var paddingX:* = 4;
      
      private var paddingY:* = 5;
      
      private var infoTxtY:Number = 0;
      
      public function NutsInfomationFukidashi()
      {
         super();
      ...
      private function changeSize() : *
      {
         ...
         this.infoMC.y = -(_loc2_ + 10) + Math.floor((_loc2_ - this.infoMC.height) / 2);
      }
