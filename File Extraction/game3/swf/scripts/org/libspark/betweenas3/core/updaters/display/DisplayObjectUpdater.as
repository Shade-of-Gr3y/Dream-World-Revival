package org.libspark.betweenas3.core.updaters.display
{
   ...
   public class DisplayObjectUpdater extends AbstractUpdater
   {
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this._destination.relativeFlags |= param3 ? 2 : 0;
            this._destination.y = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this._destination.relativeFlags |= param3 ? 8 : 0;
            this._destination.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this._destination.relativeFlags |= param3 ? 16 : 0;
            this._destination.scaleY = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this._destination.relativeFlags |= param3 ? 64 : 0;
            this._destination.rotation = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this._destination.relativeFlags |= param3 ? 1024 : 0;
            this._destination.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this._destination.relativeFlags |= param3 ? 2048 : 0;
            this._destination.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this._destination.relativeFlags |= param3 ? 4096 : 0;
      ...
      protected function getFilterByClass(param1:Class) : BitmapFilter
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc2_ = _loc3_[_loc5_] as BitmapFilter;
            if(_loc2_ is param1)
            {
               return _loc2_;
            }
      ...
      override protected function resolveValues() : void
      {
         ...
         if((_loc4_ & 0x10) != 0)
         {
            ...
            else if((_loc3_.relativeFlags & 0x10) != 0)
            {
               _loc3_.scaleY += _loc1_.scaleY;
            }
            ...
            else if((_loc2_.relativeFlags & 0x10) != 0)
            {
               _loc2_.scaleY += _loc1_.scaleY;
            }
         }
         if((_loc4_ & 0x40) != 0)
         {
            ...
            else if((_loc3_.relativeFlags & 0x40) != 0)
            {
               _loc3_.rotation += _loc1_.rotation;
            }
            ...
            else if((_loc2_.relativeFlags & 0x40) != 0)
            {
               _loc2_.rotation += _loc1_.rotation;
            }
         }
         if((_loc4_ & 0x0400) != 0)
         {
            ...
            else if((_loc3_.relativeFlags & 0x0400) != 0)
            {
               _loc3_.alpha += _loc1_.alpha;
            }
            ...
            else if((_loc2_.relativeFlags & 0x0400) != 0)
            {
               _loc2_.alpha += _loc1_.alpha;
            }
         }
         if((_loc4_ & 0x0800) != 0)
         {
            ...
            else if((_loc3_.relativeFlags & 0x0800) != 0)
            {
               _loc3_.width += _loc1_.width;
            }
            ...
            else if((_loc2_.relativeFlags & 0x0800) != 0)
            {
               _loc2_.width += _loc1_.width;
            }
         }
         if((_loc4_ & 0x1000) != 0)
         {
            ...
            else if((_loc3_.relativeFlags & 0x1000) != 0)
            {
               _loc3_.height += _loc1_.height;
            }
            ...
            else if((_loc2_.relativeFlags & 0x1000) != 0)
            {
               _loc2_.height += _loc1_.height;
            }
         }
