package bfp.common
{
   ...
   public class PokemonBridge
   {
      ...
      public static function loginError() : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(_loc1_,"/");
         _loc2_.clear();
         var _loc3_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "html/ja/logout.html";
         PokemonBridge.href(_loc3_);
      }
      ...
      public static function Error404() : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(_loc1_,"/");
         _loc2_.clear();
         var _loc3_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "error.php?code=404";
         PokemonBridge.href(_loc3_);
      }
      ...
      public static function Error403() : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(_loc1_,"/");
         _loc2_.clear();
         var _loc3_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "error.php?code=403";
         PokemonBridge.href(_loc3_);
      }
      ...
      {
         ExternalInterface.call("setpdw",false);
         var _loc1_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "error.php?code=500";
      ...
      {
         ExternalInterface.call("setpdw",false);
         var _loc1_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "error.php?code=502";
         PokemonBridge.href(_loc1_);
      }
      ...
      {
         ExternalInterface.call("setpdw",false);
         var _loc1_:String = PokemonBridge.API.slice(0,PokemonBridge.API.length - 4) + "error.php?code=503";
         PokemonBridge.href(_loc1_);
      }
