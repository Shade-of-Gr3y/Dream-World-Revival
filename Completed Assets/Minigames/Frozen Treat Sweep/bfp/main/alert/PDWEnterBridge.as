package bfp.main.alert
{
    ...
    public class PDWEnterBridge extends Object
    {
        ...
        {
            var flag:Boolean;
            var soName:* = "pokemon" + PokemonBridge.member_id;
            var _so:* = SharedObject.getLocal(soName, "/");
            var time:* = _so.data.start;
            var answer:* = time - PokemonBridge.last_started_at;
            try
            {
                Logger.log("-------------------------------");
        ...
        {
            var _loc_2:* = "pokemon" + PokemonBridge.member_id;
            var _loc_3:* = SharedObject.getLocal(_loc_2, "/");
            _loc_3.data.start = PokemonBridge.last_started_at + 24 * 3600 - param1;
            _loc_3.flush();
            Logger.log("-------------------------------");
            Logger.log(_loc_3.data.start.toString());
            Logger.log("-------------------------------");
            return;
        }// end function
        ...
        {
            var _loc_1:* = "pokemon" + PokemonBridge.member_id;
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.data.start = NaN;
            _loc_2.flush();
            Logger.log("-------------------------------");
            Logger.log(_loc_2.data.start.toString());
            Logger.log("-------------------------------");
            return;
        }// end function
