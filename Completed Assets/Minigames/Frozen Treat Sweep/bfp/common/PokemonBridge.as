package bfp.common
{
    ...
    public class PokemonBridge extends Object
    {
        ...
        public static var requestBattleHistory:Object = null;
        public static var infoRequest:Object = null;
        public static var MailerRequest:Object = null;
        ...
        private static var _site:String = "SITE_PDW";
        private static var _now:String = "SITE_PDW";
        ...
        public static function standalone(param1:String) : void
        {
            ...
            {
                param1 = param1 + ("?appver=" + PokemonBridge.version);
            }
            var _loc_2:* = new Loader();
            var _loc_3:* = new URLRequest(param1);
            var _loc_4:* = new LoaderContext();
            new LoaderContext().applicationDomain = new ApplicationDomain();
            _loc_2.contentLoaderInfo.addEventListener(Event.COMPLETE, loadedHandler);
        ...
        {
            var _loc_2:* = Loader(event.currentTarget.loader);
            _loc_2.contentLoaderInfo.removeEventListener(Event.COMPLETE, loadedHandler);
            pokerender = Class(_loc_2.contentLoaderInfo.applicationDomain.getDefinition("com.pokemon_gl.pdw.display.PokemonRenderer"));
            pokerender.imageDirectory = POKEMONPATH;
            pokerender2 = Class(_loc_2.contentLoaderInfo.applicationDomain.getDefinition("com.pokemon_gl.pdw2.display.PokemonRenderer"));
        ...
        public static function alertWindow(param1:String = "", param2:Number = 0, param3:String = null) : void
        {
            ...
            new Object().message = param1;
            _loc_4.id = param2;
            _loc_4.button = param3;
            dispatchEvent(new Event(SE_ALERT_SOUND));
            dispatchEvent(new CustomEvent(ERROR_WINDOW, _loc_4));
            return;
        }// end function
        ...
        public static function logout() : void
        {
            ExternalInterface.call("setpdw", false);
            ExternalInterface.call("setCustomize", false);
            var _loc_1:String = "pokemon-login";
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.clear();
            var _loc_3:* = PokemonBridge.API.slice(0, PokemonBridge.API.length - 4) + "?p=" + ConnectorPATH.DB_LOGOUT;
            PokemonBridge.href(_loc_3);
            return;
        }// end function
        ...
        public static function loginError() : void
        {
            ...
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.clear();
            var _loc_3:String = "/error/logout/";
            PokemonBridge.href(_loc_3);
            return;
        }// end function
        ...
        public static function acceseeError() : void
        {
            ...
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.clear();
            var _loc_3:String = "/error/logout_error/";
            PokemonBridge.href(_loc_3);
            return;
        }// end function
        ...
        public static function Error404() : void
        {
            ...
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.clear();
            var _loc_3:String = "/error.php?code=404";
            PokemonBridge.href(_loc_3);
            return;
        }// end function
        ...
        public static function Error403() : void
        {
            ...
            var _loc_2:* = SharedObject.getLocal(_loc_1, "/");
            _loc_2.clear();
            var _loc_3:String = "/error.php?code=403";
            PokemonBridge.href(_loc_3);
            return;
        }// end function
        ...
        public static function Error500() : void
        {
            ExternalInterface.call("setpdw", false);
            ExternalInterface.call("setCustomize", false);
            var _loc_1:String = "/error.php?code=500";
            PokemonBridge.href(_loc_1);
            return;
        }// end function
        ...
        public static function Error502() : void
        {
            ExternalInterface.call("setpdw", false);
            ExternalInterface.call("setCustomize", false);
            var _loc_1:String = "/error.php?code=502";
            PokemonBridge.href(_loc_1);
            return;
        }// end function
        ...
        public static function Error503() : void
        {
            ExternalInterface.call("setpdw", false);
            ExternalInterface.call("setCustomize", false);
            var _loc_1:String = "/error.php?code=503";
            PokemonBridge.href(_loc_1);
            return;
        }// end function
