package hivelocity.flight
{
   ...
   public class character extends MovieClip
   {
      ...
      static const MOVE_TIME_DISTANCE:uint = 33;
      
      static const MOVE_DISTANCE:Number = 0.03;
      
      static const MOVE_AREA:uint = 40;
      
      static const UNMOVE_AREA_SIDE:uint = 0;
      
      static const UNMOVE_AREA_TOP:uint = 40;
      
      static const UNMOVE_AREA_BOTTOM:uint = 80;
      
      static const LAYER_SPEED:uint = 1;
      
      static const LAYER_CLOUD:uint = 2;
      
      static const LAYER_THUNDER:uint = 3;
      
      static const LAYER_SPEEDANIME:uint = 4;
      
      static const SUPER_SPEED:uint = 1;
      
      static const HYPER_SPEED:uint = 2;
      ...
      {
         var _loc1_:Point = new Point(this._chara.x,this._chara.y);
         return _loc1_;
      }
      ...
      public function setActionAddSpeed(param1:String) : void
      {
         if(param1 != null)
         {
            ...
            this._addSpeedIcon.x = this._addSpeedIcon.x + this._chara.width / 2;
            if(param1 == SPEED_UP)
            {
      ...
      private function __charaMoveHandler(param1:Event = null) : void
      {
         ...
         if(!this._hitThunderFlg && !this._pauseFlg)
         {
            ...
            if(this._hitCloudFlg)
            {
               this._chara.x = this._chara.x + Math.abs(_loc2_) * 0.5;
               this._chara.y = this._chara.y + _loc3_;
            }
            else
            {
               this._chara.x = this._chara.x + _loc2_;
               this._chara.y = this._chara.y + _loc3_;
            }
