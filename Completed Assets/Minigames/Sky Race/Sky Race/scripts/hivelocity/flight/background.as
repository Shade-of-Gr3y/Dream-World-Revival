      ...
      private function __charaMoveHandler(param1:Event = null) : void
      {
         ...
         if(this._moveFlg)
         {
            ...
            while(_loc2_ < BG_NUM)
            {
               if(_loc2_ == 0)
               {
                  this._bgArr[_loc2_].x = this._bgArr[_loc2_].x + this._baseSpeed;
               }
               else
               {
            ...
            this._bgMoveNum = this._bgMoveNum + this._baseSpeed;
            this._totalDistance = this._totalDistance + this._bgspeed;
            if(this._bgMoveNum > this._bgW * 2)
            {
               if(this._bgArr.length > 1)
               {
                  this._bgMoveNum = this._bgMoveNum - this._bgW;
                  this._bgArr.push(this._bgArr.shift());
                  this._bgArr[0].x = this._bgArr[0].x - this._bgMoveNum;
                  this._bgMoveNum = 0;
