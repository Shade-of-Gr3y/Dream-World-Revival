package hivelocity.flight
{
   ...
   public class main extends MovieClip
   {
      ...
      static const BASE_SPEED:Number = 4;
      
      static const GAME_START_SPEED:Number = 0;
      
      static const GAME_ADJUST_SPEED_MAX:Number = 7;
      
      static const GAME_ADJUST_SPEED_MIN:Number = 1;
      
      static const STAGE_WIDTH:uint = 1003;
      
      static const STAGE_HEIGHT:uint = 505;
      
      static const LAYER_CHARA:uint = 1;
      
      static const LAYER_CLOUD:uint = 2;
      
      static const LAYER_BG:uint = 3;
      
      static const LAYER_ITEM:uint = 4;
      
      static const LAYER_DISTANCE:uint = 5;
      
      static const GAME_MAX_METER:uint = 1000;
      
      static const GAME_STAGE_WIDTH:uint = 31500;
      
      static const GAME_STAGE_HEIGHT:uint = 480;
      
      static const GAME_SPLIT_CLOUD_COLUMN:uint = 140;
      
      static const GAME_SPLIT_CLOUD_ROW:uint = 120;
      
      static const GAME_SPLIT_ENERGY_COLUMN:uint = 140;
      
      static const GAME_SPLIT_ENERGY_ROW:uint = 120;
      
      static const CLOUD_BASE_SPEED:Number = 2;
      
      static const CLOUD_VISIBLE_P:Number = 0.4;
      
      static const CLOUD_PATTEM:uint = 4;
      
      static const ENERGY_BASE_SPEED:Number = 2;
      
      static const ENERGY_VISIBLE_P:Number = 0.5;
      
      static const ENERGY_PATTEM:uint = 4;
      
      static const ENERGY_SPEED_DOWN:Number = 1;
      
      static const ENERGY_BASE_POINT:uint = 300;
      
      static const BACKGROUND_AJUST:Number = 0.7;
      ...
      static const OPENING_MOVE:uint = 120;
      
      static const SPEED_UP:String = "up";
      
      static const SPEED_DOWN:String = "down";
      
      static const GAME_TIME:uint = 120;
      
      static const SMALL_SIZE:uint = 54;
      
      static const MIDDLE_SIZE:uint = 134;
      
      static const LARGE_SIZE:uint = 182;
      
      static const AOUT_UP_SPEED:Number = 0.003;
      ...
      public var flightTimer:flightTimer;
      
      public var energyBox:energyBox;
      
      public var speed:MovieClip;
      
      public var goal_1_mc:MovieClip;
      
      public var speedGauge:speedGauge;
      ...
      public function get getCharaPosition() : Point
      {
         ...
         _loc1_ = this._character.getCharaPosition;
         return _loc1_;
      }
      ...
      private function enterFrameHandler(param1:Event) : void
      {
         ...
         this._loading_wait = this._loading_wait + 2;
      ...
      private function loadPokemonSwf() : void
      {
         ...
         if(!this._debugMode)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.display.x = _loc2_.display.x - _loc1_ / 2;
               _loc2_.display.y = _loc2_.display.y - _loc1_ / 2;
            }
            ...
            if(_loc3_)
            {
               ...
               _loc3_.display.x = _loc3_.display.x - _loc1_ / 2;
               _loc3_.display.y = _loc3_.display.y - _loc1_ / 2;
            }
         }
      }
      
      function pokeStateLoadCompleteHandler(param1:Event) : void
      {
      ...
      private function __init(param1:flightEvent = null) : void
      {
         ...
         else
         {
            ...
            while(_loc2_ < this._headerArr.length)
            {
               ...
               this._headerArr[_loc2_].y = this._headerArr[_loc2_].y - OPENING_MOVE;
               _loc2_++;
            }
            this._fooderArr = [];
            ...
            while(_loc3_ < this._fooderArr.length)
            {
               ...
               this._fooderArr[_loc3_].y = this._fooderArr[_loc3_].y + OPENING_MOVE;
               _loc3_++;
            }
      ...
      private function charaHitTest(param1:flightEvent = null) : void
      {
         ...
         if(this._hitCloudFlg == false && _loc5_ == false)
         {
            ...
            {
               this._gameAdjustSpeed = this._gameAdjustSpeed + AOUT_UP_SPEED;
            }
         }
         else
         {
            this._gameAdjustSpeed = this._gameAdjustSpeed - AOUT_UP_SPEED * 6;
         }
         this.setSpeed();
         ...
         if(!this._character.getThunderHitFlg)
         {
            ...
            while(_loc9_ < _loc3_.length)
            {
               ...
               {
                  if(_loc6_.hitTestObject(_loc3_[_loc9_].obj.energyHitArea_mc) && (_loc3_[_loc9_].flg && !_loc3_[_loc9_].getFlg))
                  {
      ...
      private function setEnergyPoint(param1:uint) : void
      {
         ...
         else
         {
            ...
            {
               this._gameAdjustSpeed = this._gameAdjustSpeed - ENERGY_SPEED_DOWN;
               this.setSpeed();
            }
      ...
      private function gameStartOpening(param1:flightEvent = null) : void
      {
         ...
         this._background.y = this._background.y - 300;
      ...
      private function setEnergyCombo(param1:flightEvent) : void
      {
         ...
         var _loc2_:int = param1.addpoint;
         ...
         this._gameAdjustSpeed = this._gameAdjustSpeed + param1.addspeed;
         this.setSpeed();
         _loc4_ = new Point();
         _loc4_ = this._character.getCharaPosition;
         this._addScoreIcon = new addScoreIcon();
