package hivelocity.flight.object
{
   ...
   public class objcloud extends MovieClip
   {
      ...
      static const CLOUD_POSITION_MARGIN:int = 150;
      
      static const TIMER_DISTANCE:uint = 33;
      
      static const CLOUD_POSITION_HEGHT_MARGIN:int = 0;
      ...
      private function __cloudMoveHandler(param1:Event = null) : void
      {
         ...
         if(this._moveFlg)
         {
            ...
            while(_loc2_ < this._cloudNum)
            {
               if(this._cloudObjArr[_loc2_].obj != null)
               {
                  if(this._cloudObjArr[_loc2_].flg)
                  {
                     ...
                     {
                        this._cloudObjArr[_loc2_].obj.x = this._cloudObjArr[_loc2_].obj.x + _loc3_ * 0.9;
                        this._cloudObjArr[_loc2_].move = this._cloudObjArr[_loc2_].move + _loc3_ * 0.9;
                     }
                     else
                     {
                        this._cloudObjArr[_loc2_].obj.x = this._cloudObjArr[_loc2_].obj.x + _loc3_;
                        this._cloudObjArr[_loc2_].move = this._cloudObjArr[_loc2_].move + _loc3_;
                     }
            ...
            this._cloudMoveDistance = this._cloudMoveDistance + this._cloudSpeed;
