package hivelocity.flight.object
{
   ...
   public class objenergy extends MovieClip
   {
      ...
      static const ENERGY_POSITION_COLUMN_MARGIN:int = 150;
      
      static const ENERGY_POSITION_ROW_MARGIN:int = 0;
      
      static const ENERGY_POSITION_HEIGHT_MARGIN:int = 0;
      
      static const TIMER_DISTANCE = 33;
      ...
      private function eneObjController() : void
      {
         ...
         while(_loc1_ < this._energyObjArr.length)
         {
            ...
            {
               if(!this._energyObjArr[_loc1_].flg || this._energyObjArr[_loc1_].delflg)
               {
      ...
      private function setEnergyGetDF(param1:Boolean) : void
      {
         ...
         {
            if(this._energyObjArr[_loc2_].flg && !this._energyObjArr[_loc2_].getFlg && this._energyObjArr[_loc2_].obj != null)
            {
      ...
      private function __energyMoveHandler(param1:Event = null) : void
      {
         ...
         if(this._moveFlg)
         {
            ...
            while(_loc2_ < this._energyNum)
            {
               ...
               {
                  if(this._energyObjArr[_loc2_].flg || this._energyObjArr[_loc2_].getFlg)
                  {
                     _loc3_ = this._energySpeed + this._energyObjArr[_loc2_].addspeed;
                     this._energyObjArr[_loc2_].obj.x = this._energyObjArr[_loc2_].obj.x + _loc3_;
                     this._energyObjArr[_loc2_].move = this._energyObjArr[_loc2_].move + _loc3_;
            ...
            this._energyMoveDistance = this._energyMoveDistance + this._energySpeed;
