  ...
  _initHtml2: function() {
    ...
    if (this.level >= PGL.TRIAL) {
      ...
      if (this.data.member.gsid_count < 1) {
        rombutton
          .attr('href', '/it.pokemon-gl.com/profile/#/register-gsid/')
        ...
        rombutton
          .attr('href', '/it.pokemon-gl.com/profile/#/change-rom/')
      ...
      $('#footer .trafficy').attr({ href:'/it.pokemon-gl.com/traffic/' + trafficType + '_' + trafficId + '/' }).show();
    } else {
...
PGL.Utils = {
  ...
  renderDSFont: function(fontname, str) {
    ...
    return (str || '').replace(/[①②③④⑤⑥⑦⑩⑪⑫⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇]/g, function (match) {
      return '<img src="/it.pokemon-gl.com/assets/global/images/' + fontname + '/' + match.charCodeAt().toString(16) + '.png" align="top"/>';
