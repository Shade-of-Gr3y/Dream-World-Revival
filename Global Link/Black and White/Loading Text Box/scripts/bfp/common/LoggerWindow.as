package bfp.common
{
   ...
   public dynamic class LoggerWindow extends MovieClip
   {
      ...
      public function LoggerWindow()
      {
         ...
         Logger.addEventListener(Logger.LOG,this.log);
         this.clear(null);
         this.__setProp_bt_LoggerWindow_bt_0();
         this.__setProp_txt_LoggerWindow_textarea_0();
      }
      
      internal function __setProp_txt_LoggerWindow_textarea_0() : *
      {
         try
         {
      ...
      private function log(param1:Event) : void
      {
         if(this._txt.length >= 100000)
         {
            this._txt.text = "";
         }
         this._txt.text += String(Logger.text) + "\n";
      ...
      private function clear(param1:MouseEvent) : void
      {
         this.visible = false;
      }
      ...
      internal function __setProp_bt_LoggerWindow_bt_0() : *
      {
         try
         {
      ...
      private function close(param1:Event) : void
      {
         ...
         Logger.removeEventListener(Logger.LOG,this.log);
         this._txt = null;
         this._bt = null;
      }
   }
