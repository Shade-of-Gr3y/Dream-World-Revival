package bfp.common
{
   ...
   public class ConnectorDataBase extends EventDispatcher
   {
      ...
      {
         this._num = Number(param1.bytesLoaded / param1.bytesTotal);
      ...
      private function errorConnectHandler(param1:IOErrorEvent) : void
      {
         ...
         this._error = param1.text;
         Logger.log("// ERROR : " + param1.text);
         dispatchEvent(new Event(DB_ERROR));
      }
      
      public function connect(param1:String, param2:URLVariables = null, param3:Boolean = true, param4:String = "GET", param5:Boolean = false) : void
      {
         var request:URLRequest = null;
         var DB:String = param1;
         var vars:URLVariables = param2;
         var flag:Boolean = param3;
         var method:String = param4;
         var https:Boolean = param5;
         this._num = 0;
         if(flag)
         {
